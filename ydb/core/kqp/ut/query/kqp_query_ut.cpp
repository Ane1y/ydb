    ...
    Y_UNIT_TEST(DiscardSelectSupport) {
        ...
        {    
            TVector<TString> queries = {
                ...
                // "DISCARD SELECT e1.Key, e2.Value 
                // FROM `/Root/EightShard` AS e1 
                // JOIN `/Root/EightShard` AS e2 ON e1.Key = e2.Key"
            };
        ...
        // {
        //     TVector<TString> queries = {
        //         "SELECT 1; DISCARD SELECT 2; DISCARD SELECT COUNT(*) FROM `/Root/EightShard`; SELECT COUNT(*) FROM `/Root/EightShard`"
        //     };
